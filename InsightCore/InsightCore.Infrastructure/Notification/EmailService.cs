...
namespace InsightCore.Infrastructure.Notification
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendPasswordChangedNotificationEmailAsync(string toEmail, string? userName = null)
        {
            var frontendUrl = _configuration["AppSettings:FrontendUrl"]?.TrimEnd('/') ?? "https://pyrosfit.com";
            var loginLink = $"{frontendUrl}/login";
            var html = BuildPasswordChangedHtml(loginLink, userName);
            await SendEmailAsync(toEmail, "Tu contraseña ha sido actualizada con éxito 🔒 - PyrosFit", html);
        }
  ...
  <body style=""margin: 0; padding: 0; background-color: #080808; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;"">
    <table role=""presentation"" width=""100%"" cellspacing=""0"" cellpadding=""0"" border=""0"" style=""background-color: #080808; padding: 40px 10px;"">
      <tr>
        ...
        private string BuildPasswordChangedHtml(string loginLink, string? userName)
        {
            var greeting = string.IsNullOrWhiteSpace(userName) ? "Hola" : $"Hola, {userName}";
...
<html lang=""es"">
  <head>
    <meta charset=""utf-8"">
    <meta name=""viewport"" content=""width=device-width, initial-scale=1.0"">
    <title>Contraseña actualizada - PyrosFit</title>
  </head>
  <body style=""margin: 0; padding: 0; background-color: #080808; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;"">
    <table role=""presentation"" width=""100%"" cellspacing=""0"" cellpadding=""0"" border=""0"" style=""background-color: #080808; padding: 40px 10px;"">
      <tr>
            ...
            <tr>
              <td style=""padding: 28px 36px 36px 36px;"">
                ...
                <p style=""color: #a0a0a0; font-size: 15px; line-height: 1.6; margin: 0 0 20px 0;"">
                  Te informamos que la contraseña de tu cuenta en <strong style=""color: #ffffff;"">PyrosFit</strong> ha sido cambiada exitosamente el <strong style=""color: #cccccc;"">{timestamp}</strong>.
                </p>
                
                <div style=""background-color: #171717; border-left: 3px solid #00d26a; border-radius: 4px; padding: 14px 18px; margin-bottom: 24px;"">
                  <p style=""color: #00d26a; font-size: 14px; font-weight: 700; margin: 0 0 4px 0;"">
                    ✓ Cambio confirmado
                  </p>
                ...
                <table role=""presentation"" width=""100%"" cellspacing=""0"" cellpadding=""0"" border=""0"">
                  <tr>
                    <td align=""center"" style=""padding: 8px 0 24px 0;"">
                      <a href=""{loginLink}"" target=""_blank"" style=""display: inline-block; background: linear-gradient(135deg, #ff6b00 0%, #e64a00 100%); color: #ffffff; font-size: 15px; font-weight: 800; text-decoration: none; padding: 16px 36px; border-radius: 10px; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 6px 20px rgba(255, 107, 0, 0.35);"">
                        INICIAR SESIÓN &rarr;
                      </a>
                    </td>
                  </tr>
                ...
                <div style=""background-color: #1a1515; border-left: 3px solid #ff4444; border-radius: 4px; padding: 12px 16px; margin-top: 12px;"">
                  <p style=""color: #ff8888; font-size: 12px; line-height: 1.5; margin: 0;"">
                    ⚠️ <strong>¿No fuiste tú?</strong> Si no realizaste este cambio, restablece tu contraseña de inmediato desde la pantalla de inicio o contacta al equipo de soporte de PyrosFit para proteger tu cuenta.
                  </p>
                </div>
              </td>
            </tr>
